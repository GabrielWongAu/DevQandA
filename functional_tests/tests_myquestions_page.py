...
class TestMyQuestionsPage(StaticLiveServerTestCase):
    ...
    def test_no_questions_alert_is_displayed(self):
        self.browser.get('http://127.0.0.1:8000/question/my_questions/')
